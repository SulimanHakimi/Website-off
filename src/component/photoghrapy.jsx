      ...
      <div className="pb-8 overflow-hidden">
        <div className=" w-72 shadow-xl flex flex-col overflow-hidden rounded-lg cursor-pointer">
          ...
          <div className="w-full  mb-2 flex justify-around">
            <Link to='/editPage'>
              <button className="bg-green-700 hover:shadow-2xl  hover:shadow-green-900 hover:text-white px-5 py-2 rounded-md">
                Edit
              </button>
            </Link>
            <button
              onClick={(e) => onDelete(e, pop.id)}
              className="bg-red-800 hover:shadow-2xl hover:shadow-red-900 hover:text-white px-5 py-2 rounded-md"
            >
              Delete
            </button>
          </div>
